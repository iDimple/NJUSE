...
PUBLIC void TestA();               //normal proc
PUBLIC void TestB();               //barber proc
PUBLIC void TestC();               //customers1 proc
PUBLIC void TestD();               //customers2 proc
PUBLIC void TestE();               //customer33 proc
...
PUBLIC  int     p(struct semaphore * s);
PUBLIC  int     v(struct semaphore * s );
